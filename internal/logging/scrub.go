...
// (matched via the same key vocabulary as attribute scrubbing) replaced.
// Request-logging middleware must use this instead of u.String() -- magic
// link tokens and participant emails will travel in query strings, which
// attribute-key redaction alone cannot catch.
